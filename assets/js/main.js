...
const PORTFOLIO = [
  {
    ...
    storeLinks: [
      { label: "App Store",   url: "https://apps.apple.com/uz/app/trastpay/id6443658536",                             key: "apple"  },
      { label: "Google Play", url: "https://play.google.com/store/apps/details?id=trastpay.uz&pcampaignid=web_share", key: "gplay"  },
      { label: "AppGallery",  url: "https://appgallery.huawei.com/app/C113904587",                                    key: "huawei" }
    ],
    caseStudy: {
...
(function () {
  ...
  function renderPortfolio(wrap) {
    ...
    var STORE_SVG = {
      apple:  '<svg viewBox="0 0 24 24" fill="currentColor" width="14" height="14"><path d="M18.71 19.5c-.83 1.24-1.71 2.45-3.05 2.47-1.34.03-1.77-.79-3.29-.79-1.53 0-2 .77-3.27.82-1.31.05-2.3-1.32-3.14-2.53C4.25 17 2.94 12.45 4.7 9.39c.87-1.52 2.43-2.48 4.12-2.51 1.28-.02 2.5.87 3.29.87.78 0 2.26-1.07 3.8-.91.65.03 2.47.26 3.64 1.98-.09.06-2.17 1.28-2.15 3.81.03 3.02 2.65 4.03 2.68 4.04-.03.07-.42 1.44-1.38 2.83M13 3.5c.73-.83 1.94-1.46 2.94-1.5.13 1.17-.34 2.35-1.04 3.19-.69.85-1.83 1.51-2.95 1.42-.15-1.15.41-2.35 1.05-3.11z"/></svg>',
      gplay:  '<svg viewBox="0 0 24 24" fill="currentColor" width="14" height="14"><path d="M3 20.5v-17c0-1.1 1.22-1.65 2.05-.95L19 12 5.05 21.45C4.22 22.15 3 21.6 3 20.5zM3.93 3.26v17.48L14.78 12 3.93 3.26zM16.15 12.71L5.3 23.56 19 15l-2.85-2.29zM5.3.44l10.85 10.85L19 9 5.3.44z"/></svg>',
      huawei: '<svg viewBox="0 0 24 24" fill="currentColor" width="14" height="14"><path d="M3 3h8v8H3V3zm2 2v4h4V5H5zm8-2h8v8h-8V3zm2 2v4h4V5h-4zM3 13h8v8H3v-8zm2 2v4h4v-4H5zm8-2h8v8h-8v-8zm2 2v4h4v-4h-4z"/></svg>'
    };
    var allCards = PORTFOLIO.map(function (p, i) {
      ...
      var storeBadges = p.storeLinks
        ? '<div class="store-links">' + p.storeLinks.map(function(s) {
            return '<a class="store-link" href="' + s.url + '" target="_blank" rel="noopener">' + (STORE_SVG[s.key] || '') + '<span>' + s.label + '</span></a>';
          }).join('') + '</div>'
        : '';
      return '' +
